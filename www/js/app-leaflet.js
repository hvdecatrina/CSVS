L.SiteGroup = L.FeatureGroup.extend({
  options: {
    ...
    styles: {unselected: {radius: 5, opacity: 0.67, fillOpacity: 0.67, fillColor: "#800000", color: "#000", weight: 1},
             selected: {radius: 8, opacity: 0.67, fillOpacity: 0.67, fillColor: "#ff4040", color: "#000", weight: 1},
              click:{radius: 8, opacity: 0.67, fillOpacity: 0.67, fillColor: "#ddb926", color: "#000", weight: 2}
    },
    contextmenu: false
  },
...
L.SiteMarker = L.CircleMarker.extend({
  ...
  inPolygon: function(polygons, pip) {
    ...
    var n = this._parent.options.visibleSites.indexOf(this.properties.key[0])
    if(n != -1){
      var t = this;  
